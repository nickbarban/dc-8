...
class PersonGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Person entity")
        ...
        .repeat(2) {
            ...
            .post("/api/people")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "firstname":"SAMPLE_TEXT", "lastname":"SAMPLE_TEXT", "birthday":"2020-01-01T00:00:00.000Z", "address":"SAMPLE_TEXT", "phone1":"SAMPLE_TEXT", "phone2":"SAMPLE_TEXT", "email":"SAMPLE_TEXT", "photoUrl":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
